 ...
 */
class Tx_Vidi_ViewHelpers_ExtDirectProviderViewHelper extends Tx_Vidi_ViewHelpers_AbstractViewHelper {
	
	/**
	 * @var Tx_Vidi_ExtDirect_Api
	 */
	...
	public function initializeArguments() {
		...
		$this->apiService = $objectManager->create('Tx_Vidi_MVC_ExtDirect_Api');
	}
	...
	public function render($name = 'remoteDescriptor',
		...
		if ($routeUrl === NULL) {
			$routeUrl = $this->controllerContext->getUriBuilder()->reset()->build() . '&Tx_Vidi_ExtDirectRequest=1';
		}
